...
why3_vc Div_1_left using assms by (simp add: ediv_def)

why3_vc Div_inf using assms by (simp add: ediv_def)

why3_vc Div_inf_neg
  using assms
  by (cases "x = y") (simp_all add: ediv_def zdiv_zminus1_eq_if)
...
why3_vc Div_minus1_left
  using assms
  by (simp only: zdiv_zminus1_eq_if ediv_def, simp)

why3_vc Mod_0 by (simp add: emod_def)

why3_vc Mod_1 by (simp add: emod_def)

why3_vc Mod_1_left using assms by (simp add: emod_def)

why3_vc Mod_minus1_left
  using assms
  by (simp only: emod_def zmod_zminus1_eq_if, simp)
...
why3_vc Div_inf using assms by (simp add: cdiv_def)
...
why3_vc Mod_inf using assms by (simp add: cmod_def sgn_if)
